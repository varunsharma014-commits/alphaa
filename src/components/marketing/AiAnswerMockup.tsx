  ...
  return (
    <section data-reveal className="px-4 sm:px-6 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Chat window mockup */}
        <div className="rounded-2xl border border-line/10 bg-fg/[0.02] overflow-hidden shadow-2xl">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-line/[0.06]">
            <span className="w-2.5 h-2.5 rounded-full bg-fg/15" />
            <span className="w-2.5 h-2.5 rounded-full bg-fg/15" />
            <span className="w-2.5 h-2.5 rounded-full bg-fg/15" />
            <span className="ml-3 inline-flex items-center gap-1.5 text-fg/40 text-xs">
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="flex items-start gap-3">
              <div className="w-7 h-7 rounded-full bg-fg/10 flex items-center justify-center flex-shrink-0">
                <User className="w-4 h-4 text-fg/50" />
              </div>
              <p className="text-fg/85 text-sm leading-relaxed pt-1">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm leading-relaxed text-fg/70 space-y-3 pt-1 min-w-0">
