...
export function buildAuditPrompt(businessName: string, city: string, websiteUrl: string) {
  return `You are Alphaa's visibility audit engine. Analyze this local business and generate a realistic visibility audit.
...
Return ONLY valid JSON with this exact structure — no markdown, no explanation:
{
  ...
  "competitor_insight": "<1-2 sentences about local competition finding you on searches>",
  "ai_search_status": {
...
- Issues must be specific to the business type and city — mention them by name
- NEVER use words: schema, AEO, LLM, entity, structured data, semantic, generative engine
- DO use: Google, ChatGPT, Maps, "your website", "your business profile", "people searching"
- Always include at least: weak Google Business Profile activity, missing FAQ content, low AI search appearance, inconsistent business info across the web, missing service pages, no recent reviews
