...
export default function BusinessSettingsPage() {
  ...
  return (
    <div>
      <h1 style={{ fontSize: "22px", fontWeight: 500, color: "var(--ds-text)" }}>Business details</h1>
      <p style={{ fontSize: "14.3px", color: "var(--ds-text-mute)", marginTop: "4px", marginBottom: "20px", lineHeight: 1.6 }}>
      ...
      <DsCard>
        {loading ? (
          <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "12px 0", color: "var(--ds-text-mute)", fontSize: "14.3px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              ...
              />
              <p style={{ fontSize: "12.1px", color: "var(--ds-text-faint)", marginTop: "6px", lineHeight: 1.5 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              {saved && (
                <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", fontSize: "13.2px", color: "var(--ds-ok)" }}>
                  <Check size={14} /> Saved — alphaa will use these from now on
                </span>
              )}
              {error && <span style={{ fontSize: "13.2px", color: "var(--ds-warn)" }}>{error}</span>}
            </div>
          </div>
        )}
      </DsCard>
