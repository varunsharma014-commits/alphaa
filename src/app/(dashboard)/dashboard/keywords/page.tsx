...
export default async function KeywordsPage() {
  ...
  if (!integration || !hasGsc) {
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        <div>
          <h1 className="text-fg font-semibold text-2xl">Keywords</h1>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/[0.10] via-transparent to-transparent p-12">
          ...
          <div className="relative flex flex-col items-center text-center gap-5 max-w-sm mx-auto">
            ...
            <div className="space-y-2">
              <h2 className="text-fg font-bold text-xl">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#FF6B1A] hover:bg-[#ff8040] text-fg font-semibold text-sm transition-colors"
            >
              Connect Google
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[#FF6B1A]/20 bg-gradient-to-br from-[#FF6B1A]/[0.10] via-transparent to-transparent p-12">
          ...
          <div className="relative flex flex-col items-center text-center gap-5 max-w-sm mx-auto">
            ...
            <div className="space-y-2">
              <h2 className="text-fg font-bold text-xl">Syncing your data…</h2>
              <p className="text-fg/40 text-sm leading-relaxed">
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/[0.12] via-transparent to-transparent p-5">
          ...
          <div className="relative space-y-1">
            ...
            <p className="text-fg font-bold text-3xl font-mono leading-none">
              {formatNumber(totalClicks)}
            </p>
            <p className="text-fg/30 text-xs">last 28 days</p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-500/[0.12] via-transparent to-transparent p-5">
          ...
          <div className="relative space-y-1">
            ...
            <p className="text-fg/30 text-xs">times shown</p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-green-500/20 bg-gradient-to-br from-green-500/[0.12] via-transparent to-transparent p-5">
          ...
          <div className="relative space-y-1">
            ...
            <p className="text-fg/30 text-xs">avg. across keywords</p>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[#FF6B1A]/20 bg-gradient-to-br from-[#FF6B1A]/[0.12] via-transparent to-transparent p-5">
          ...
          <div className="relative space-y-1">
            ...
            <p className="text-fg/30 text-xs">keywords on page 1</p>
          </div>
        </div>
      </div>
      ...
      <div>
        <h2 className="text-fg font-semibold text-sm mb-3 px-0.5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-green-500/20 bg-gradient-to-br from-green-500/[0.08] via-transparent to-transparent p-5 flex flex-col gap-2">
            ...
            <p className="text-fg font-bold text-4xl font-mono leading-none">{top3}</p>
            <div>
              <p className="text-fg/70 text-sm font-medium">Top 3</p>
              <p className="text-fg/30 text-xs">positions 1–3</p>
            </div>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-teal-500/20 bg-gradient-to-br from-teal-500/[0.08] via-transparent to-transparent p-5 flex flex-col gap-2">
            ...
            <p className="text-fg font-bold text-4xl font-mono leading-none">{page1}</p>
            <div>
              <p className="text-fg/70 text-sm font-medium">Page 1</p>
              <p className="text-fg/30 text-xs">positions 4–10</p>
            </div>
            <span className="text-xl">📄</span>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-amber-500/20 bg-gradient-to-br from-amber-500/[0.08] via-transparent to-transparent p-5 flex flex-col gap-2">
            ...
            <p className="text-fg font-bold text-4xl font-mono leading-none">{pages23}</p>
            <div>
              <p className="text-fg/70 text-sm font-medium">Pages 2–3</p>
              <p className="text-fg/30 text-xs">positions 11–30</p>
            </div>
            <span className="text-xl">📈</span>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-red-500/20 bg-gradient-to-br from-red-500/[0.08] via-transparent to-transparent p-5 flex flex-col gap-2">
            ...
            <p className="text-fg font-bold text-4xl font-mono leading-none">{beyond}</p>
            <div>
              <p className="text-fg/70 text-sm font-medium">Beyond</p>
              <p className="text-fg/30 text-xs">positions 30+</p>
            </div>
      ...
      <GlassCard className="p-0 overflow-hidden">
        <div className="px-5 py-4 border-b border-line/[0.06]">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-line/[0.06]">
                <th className="text-left pl-5 pr-4 py-3 text-fg/30 text-xs font-medium uppercase tracking-wider whitespace-nowrap">
                  Keyword
                </th>
                <th className="text-left px-4 py-3 text-fg/30 text-xs font-medium uppercase tracking-wider whitespace-nowrap">
                  Position
                </th>
                <th className="text-right px-4 py-3 text-fg/30 text-xs font-medium uppercase tracking-wider whitespace-nowrap">
                  Clicks
                </th>
                <th className="text-right px-4 py-3 text-fg/30 text-xs font-medium uppercase tracking-wider whitespace-nowrap">
                  Impressions
                </th>
                <th className="text-right px-4 py-3 pr-5 text-fg/30 text-xs font-medium uppercase tracking-wider whitespace-nowrap">
                  Click Rate
                </th>
              </tr>
            </thead>
            <tbody>
              {rankings.map((row, idx) => {
                ...
                return (
                  <tr
                    key={idx}
                    className="border-b border-line/[0.04] last:border-0 transition-colors hover:bg-fg/[0.02]"
                  >
                    {/* Keyword */}
                    ...
                    {/* Impressions */}
                    <td className="px-4 py-3 text-right">
                      <span className="text-fg/40 font-mono text-xs">
        ...
        {/* Legend */}
        <div className="px-5 py-3 border-t border-line/[0.06] flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-1.5 text-xs text-fg/30">
