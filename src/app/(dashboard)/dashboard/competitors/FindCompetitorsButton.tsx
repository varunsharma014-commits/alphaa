  ...
  return (
    <div className="space-y-2">
      <button
        ...
        style={{ background: "var(--ds-accent)", color: "var(--ds-text)", fontSize: 14.3, fontWeight: 500, padding: "9px 20px" }}
      >
        {loading ? (
          <>
      ...
      {error && (
        <p className="pl-1" style={{ color: "var(--ds-bad-soft)", fontSize: 12.1, lineHeight: 1.6 }}>{error}</p>
      )}
    </div>
  )
}
