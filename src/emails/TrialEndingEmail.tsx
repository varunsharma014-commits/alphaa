...
const urgencyText = { color: "#d70015", fontSize: "13.2px", fontWeight: "600", letterSpacing: "1px", margin: "0", textAlign: "center" as const }
...
const loseItem = { color: "#424245", fontSize: "15.4px", margin: "0 0 8px", lineHeight: "1.5" }
