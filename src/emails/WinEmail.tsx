...
const winBannerText = { color: "#1d8a4e", fontSize: "12px", fontWeight: "600", letterSpacing: "1px", margin: "0", textAlign: "center" as const }
...
const winItem = { color: "#424245", fontSize: "14px", margin: "0 0 8px", lineHeight: "1.5" }
...
const shareNote = { color: "#6e6e73", fontSize: "13px", lineHeight: "1.6", margin: "0 0 24px" }
