...
const urgencyText = { color: "#b64400", fontSize: "12px", fontWeight: "600", letterSpacing: "1px", margin: "0", textAlign: "center" as const }
...
const pauseItem = { color: "#424245", fontSize: "14px", margin: "0 0 8px", lineHeight: "1.5" }
