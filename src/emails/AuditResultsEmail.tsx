...
const h1 = { color: "#1d1d1f", fontSize: "28.6px", fontWeight: "600", margin: "0 0 12px", lineHeight: "1.2" }
...
const scoreLabel2 = { color: "#86868b", fontSize: "11px", fontWeight: "600", letterSpacing: "2px", margin: "0 0 6px" }
const scoreValue = { color: "#1d1d1f", fontSize: "48.4px", fontWeight: "600", margin: "0", lineHeight: "1" }
const scoreUnit = { fontSize: "22px", color: "#86868b" }
const scoreBadge = { fontSize: "14.3px", fontWeight: "600", margin: "6px 0 0" }
const scoreBadge2 = { fontSize: "14.3px", color: "#6e6e73", margin: "6px 0 0" }
...
const engineStatus = { fontSize: "17.6px", fontWeight: "600", margin: "0" }
const engineName = { color: "#1d1d1f", fontSize: "15.4px", fontWeight: "600", margin: "0" }
const engineSnippet = { color: "#6e6e73", fontSize: "14.3px", fontStyle: "italic", margin: "2px 0 0" }
const engineMissing = { color: "#d70015", fontSize: "13.2px", margin: "2px 0 0", opacity: 0.7 }
...
const issueLabel = { color: "#0066cc", fontSize: "11px", fontWeight: "600", letterSpacing: "2px", margin: "0 0 6px" }
const issueText = { color: "#1d1d1f", fontSize: "15.4px", lineHeight: "1.6", margin: "0" }
const ctaHeading = { color: "#1d1d1f", fontSize: "22px", fontWeight: "600", margin: "0 0 12px" }
const button = { backgroundColor: "#0071e3", color: "#ffffff", borderRadius: "980px", fontSize: "16.5px", fontWeight: "400", padding: "12px 24px", textDecoration: "none", display: "inline-block", margin: "0 0 12px" }
const trialNote = { color: "#86868b", fontSize: "13.2px", margin: "0 0 24px" }
const footer = { padding: "20px 40px", borderTop: "1px solid #d2d2d7" }
const footerText = { color: "#86868b", fontSize: "13.2px", textAlign: "center" as const, margin: "0 0 8px" }
const footerLink = { color: "#86868b", textDecoration: "none" }
const footerDisclaimer = { color: "#86868b", fontSize: "12.1px", textAlign: "center" as const, margin: "0", lineHeight: "1.5" }
