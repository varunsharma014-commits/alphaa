...
const logo = { color: "#1d1d1f", fontSize: "22px", fontWeight: "600", margin: "0 0 24px" }
const content = { padding: "40px 40px 0" }
const h1 = { color: "#1d1d1f", fontSize: "30.8px", fontWeight: "600", margin: "0 0 16px", lineHeight: "1.2" }
const paragraph = { color: "#424245", fontSize: "17.6px", lineHeight: "1.6", margin: "0 0 16px" }
const checklist = { backgroundColor: "#ffffff", borderRadius: "12px", padding: "20px 24px", margin: "24px 0" }
const checkItem = { color: "#1d1d1f", fontSize: "16.5px", margin: "0 0 8px", lineHeight: "1.5" }
const button = { backgroundColor: "#0071e3", color: "#ffffff", borderRadius: "980px", fontSize: "17.6px", fontWeight: "400", padding: "14px 28px", textDecoration: "none", display: "inline-block", margin: "8px 0 24px" }
const hr = { borderColor: "#d2d2d7", margin: "24px 0" }
const smallText = { color: "#6e6e73", fontSize: "14.3px", lineHeight: "1.6", margin: "0 0 8px" }
const link = { color: "#0066cc", textDecoration: "none" }
const footer = { padding: "24px 40px", borderTop: "1px solid #d2d2d7" }
const footerText = { color: "#86868b", fontSize: "13.2px", margin: "0 0 4px", textAlign: "center" as const }
