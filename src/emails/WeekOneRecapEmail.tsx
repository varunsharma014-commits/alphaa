...
const recapItem = { color: "#424245", fontSize: "15.4px", margin: "0 0 8px", lineHeight: "1.5" }
...
const scoreLabel = { color: "#6e6e73", fontSize: "12.1px", fontWeight: "600", letterSpacing: "1px", margin: "0 0 4px" }
const scoreValue = { color: "#0066cc", fontSize: "30.8px", fontWeight: "600", margin: "0" }
...
const scheduleItem = { color: "#424245", fontSize: "15.4px", margin: "0 0 8px", lineHeight: "1.5" }
...
const footerText = { color: "#86868b", fontSize: "13.2px", textAlign: "center" as const, margin: "0 0 4px" }
